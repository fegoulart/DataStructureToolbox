...
public class BinaryTreeNode<T: Comparable> {
    ...
    public static func traverseInOrder(node: BinaryTreeNode?) {
    ...
    public static func traversePreOrder(node: BinaryTreeNode?) {
        guard let node = node else {
            return
        }
        print(node.value)
    ...
    public static func traversePostOrder(node: BinaryTreeNode?) {
        guard let node = node else {
            return
        }
